...
is ( $number_pids_in_record, 1 );&debug_obj($number_pids_in_record);

my $pids_recorded = undef;
( $number_pids_in_record, $pids_recorded ) = $obj->number_pids("$drvmap_key");
&debug_obj($pids_recorded);
