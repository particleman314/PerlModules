...
my $result = &is_proper_subset($setobj2, $setobj1);
is ( $result eq TRUE, 1 );

$result = &is_proper_subset($setobj3, $setobj1);
is ( $result eq TRUE, 1 );

$result = &is_proper_subset($setobj1, $setobj1);
is ( $result eq FALSE, 1 );

$result = &is_proper_subset($setobj1, $setobj3);
is ( $result eq FALSE, 1 );

$result = &is_proper_subset($setobj2, $setobj3);
is ( $result eq FALSE, 1 );

$result = &is_proper_subset($setobj3, $setobj2);
is ( $result eq FALSE, 1 );
