...
my $clonable_object = &create_object('c__HP::Array::Stack__');
...
{
  return sub { my $obj = HP::Array::Stack->new( {&ARRAY_SKIP_CLONE_OPTION => TRUE} ); };
}
...
sub time_construction
{
  if ( scalar(@_) < 0 or $_[0] < 0 ) {
    &diag("\n----> No report done for HP::Array::Stack.\n");
	return 0;
  }
