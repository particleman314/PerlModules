...
my $clonable_object = &create_object('c__HP::Array::PriorityQueue__');
...
{
  return sub { my $obj = HP::Array::PriorityQueue->new( {&ARRAY_SKIP_CLONE_OPTION => TRUE} ); };
}
...
sub time_construction
{
  if ( scalar(@_) < 0 or $_[0] < 0 ) {
    &diag("\n----> No report done for HP::Array::PriorityQueue.\n");
	return 0;
  }
