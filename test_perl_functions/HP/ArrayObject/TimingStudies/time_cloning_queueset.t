...
my $clonable_object = &create_object('c__HP::Array::QueueSet__');
...
{
  return sub { my $obj = HP::Array::QueueSet->new( {&ARRAY_SKIP_CLONE_OPTION => TRUE} ); };
}
...
sub time_construction
{
  if ( scalar(@_) < 0 or $_[0] < 0 ) {
    &diag("\n----> No report done for HP::Array::QueueSet.\n");
	return 0;
  }
