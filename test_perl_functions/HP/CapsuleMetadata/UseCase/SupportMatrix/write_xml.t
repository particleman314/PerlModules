...
&createDBs();
my $input_xmlfile  = "$FindBin::Bin/test_usecase_manifest-support.xml";
my $output_xmlfile = "$FindBin::Bin/test_usecase_manifest-support-output.xml";
...
is ( $results[0]->{'message'} eq 'Rogue attribute \'mandatory\' in element \'provider\'.', 1 );
