...
&createDBs();
my $input_xmlfile  = "$FindBin::Bin/../../SettingsFiles/test_oo_manifest.xml";
my $output_xmlfile = "$FindBin::Bin/test_oo_manifest-output.xml";

&delete("$output_xmlfile");
my $obj = &create_object('c__HP::CapsuleMetadata::OO__');
is ( defined($obj), 1 );
