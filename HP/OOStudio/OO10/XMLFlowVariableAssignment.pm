package HP::OOStudio::OO10::XMLFlowVariableAssignment;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_oo10_xmlflowvariableassignment_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
					   'name'                 => undef,
					   'action'               => undef,
					   'assignmentTargetType' => undef,
					   'contextKey'           => undef,
					   'expression'           => 'c__HP::OOStudio::OO10::XMLExpression__',
		              };
