package HP::OOStudio::OO10::XMLAssignments;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_oo10_xmlassignments_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
					   'flowVariableAssignments' => '[] c__HP::OOStudio::OO10::XMLFlowVariableAssignment__',
		              };
