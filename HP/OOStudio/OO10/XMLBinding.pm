package HP::OOStudio::OO10::XMLBinding;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_oo10_xmlbinding_pm'} ||
...
sub convert_output
  {
	...
	my $fields     = [ 'assignFromContext', 'assignToContext', 'isList', 'required' , 'isPersisted', 'record' ];
