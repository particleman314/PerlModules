package HP::OOStudio::OO10::XMLGroupAliasRef;
...
BEGIN 
  {
	...
	use parent qw(HP::OOStudio::OO10::OOStudioObject HP::OOStudio::OO10::XMLReferenceID);
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_oo10_xmlgroupaliasref_pm'} ||
