package HP::OOStudio::OO9::XMLBindingLink;
...
BEGIN 
  {
	...
	use parent qw(HP::OOStudio::OO9::OOStudioObject HP::OOStudio::OO9::XMLReferenceID);
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_oo9_xmlbindinglink_pm'} ||
