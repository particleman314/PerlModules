package HP::OOStudio::OO9::XMLFilters;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_xmlfilters_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
					   'stripTrailingFilters'   => '[] c__HP::OOStudio::OO9::XMLStripTrailingFilter__',
					   'stripWhiteSpaceFilters' => '[] c__HP::OOStudio::OO9::XMLStripWhiteSpaceFilter__',
					   'regexFilters'           => '[] c__HP::OOStudio::OO9::XMLRegexFilter__',
		              };
