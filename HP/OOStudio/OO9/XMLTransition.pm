package HP::OOStudio::XMLTransition;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_xmltransition_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
					   ...
					   'shouldHandoff'         => FALSE,
					   'transitionValue'       => 0.0,
					   'destination'           => '__HP::OOStudio::XMLReferenceID__',
					   'source'                => '__HP::OOStudio::XMLReferenceID__',
					   'positions'             => [ [], '__HP::OOStudio::XMLPoint__', 1 ],
					   'labelPosition'         => '__HP::OOStudio::XMLPoint__',
		              };
