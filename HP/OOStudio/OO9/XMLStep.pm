...
BEGIN 
  {
	...
	use parent qw(HP::OOStudio::OOStudioObject);
...
sub data_types
  {
    ...
    my $data_fields = {
					   'name'                  => undef,
					   'bounds'                => '__HP::OOStudio::XMLPoint__',
					   'layer'                 => -1,
					   'hideInBound'           => FALSE,
					   ...
					   'scriptlet'             => '__HP::OOStudio::XMLScriptlet__',
					   'bindings'              => '__HP::OOStudio::XMLBindings__',
					   'transitions'           => [ [], '__HP::OOStudio::XMLTransition__', 1 ],
					   'properties'            => [],
					   'opRef'                 => '__HP::OOStudio::XMLReferenceID__',
					   'assignments'           => [],
					   'throttleSize'          => 0,
					   'returnStepType'        => undef,
					   'iconSpec'              => '__HP::OOStudio::XMLIconSpec__',
		              };
