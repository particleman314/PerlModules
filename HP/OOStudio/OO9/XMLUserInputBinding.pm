package HP::OOStudio::OO9::XMLUserInputBinding;
...
BEGIN 
  {
	...
	use parent qw(HP::OOStudio::OO9::OOStudioObject HP::OOStudio::OO9::XMLBinding);
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_oo9_xmluserinputbinding_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
	                   'prompt'         => undef,
					   'link'           => 'c__HP::OOStudio::XMLBindingLink__',
					   'isMultiSelect'  => FALSE,
		              };
