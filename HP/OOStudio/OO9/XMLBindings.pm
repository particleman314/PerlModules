package HP::OOStudio::OO9::XMLBindings;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_oo9_xmlbindings_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
					   'staticBinding'    => '[] c__HP::OOStudio::OO9::XMLStaticBinding__',
					   'userInputBinding' => '[] c__HP::OOStudio::OO9::XMLUserInputBinding__',
		              };
