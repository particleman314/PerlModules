package HP::OOStudio::OO9::XMLVersion;
...
BEGIN 
  {
	...
	use parent qw(HP::OOStudio::OO9::OOStudioObject HP::OOStudio::OO9::XMLNode);
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_oo9_xmlversion_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
	                   'child' => '[] c__HP::OOStudio::OO9::XMLChild__',
		              };
