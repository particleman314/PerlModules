...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_oostudio_xmlwebop_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
	                   'categories'                 => '__HP::OOStudio::XMLCollection__',
					   'defaultContent'             => FALSE,
					   'fieldValues'                => '__HP::OOStudio::XMLMap__',
					   'hidden'                     => undef,
					   'name'                       => undef,
					   'version'                    => undef,
					   'accessControList'           => '__HP::OOStudio::XMLCollection__',
					   'availableResultExpressions' => '__HP::OOStudio::XMLCollection__',
					   'iconSpec'                   => '__HP::OOStudio::XMLIconSpec__';
					   'inputs'                     => '__HP::OOStudio::XMLCollection__',
					   'possibleResponses'          => '__HP::OOStudio::XMLCollection__',
					   'rasRef'                     => '__HP::OOStudio::XMLReferenceID__',
					   'resultExpression'           => '__HP::OOStudio::XMLExpression__',
