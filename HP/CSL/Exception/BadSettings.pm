package HP::FileManager::Exception::ChangePermissions;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_filemanager_exception_changepermissions_pm'} ||
	             $ENV{'debug_filemanager_exception_modules'} ||
                 $ENV{'debug_filemanager_modules'} ||
