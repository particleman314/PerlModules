package HP::Environment::binutils;
...
#=============================================================================
# Set up loader for BinUtils.
sub install_package()
  {
    $HP::Environment::Config::ec_installs{'binutils'} = {
                                                            '*' => {
                                                                    'searchtype' => 'opt',
                                                                    'subpath'    => [ 'build' ],
                                                                    'platforms'  => 'linux',
								    'configfunc' => \&config_environment_binutils,
                                                                   }
    };
  }

#=============================================================================
sub config_environment_binutils($;$$)
  {
    my ($pkgdir, $version, $package) = @_;
    &eh_setenv('BINUTILS', "$pkgdir");
