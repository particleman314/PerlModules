...
#=============================================================================
# Set up loader for WGET.
sub install_package()
  {
    $HP::Environment::Config::ec_installs{'wget'} = {
							'*' => {
								'searchtype' => 'opt',
								'subpath'    => [ '', 'wget' ],
								'configfunc' => \&config_environment_wget,
							       }
						       };
  }

#=============================================================================
sub config_environment_wget($;$$)
  {
    my ($pkgdir, $version, $package) = @_;

    # Environment variables
    &eh_setenv('WGET', "$pkgdir");

    # System path
    &eh_remove_path('wget-\d');
