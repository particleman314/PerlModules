package HP::Array::Exceptions::BaseArrayException;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_array_exceptions_basearrayexception_pm'} ||
...
sub new
  {
    my $class       = shift;
	my $type        = shift || __PACKAGE__;
    my $data_fields = shift || &data_types();
