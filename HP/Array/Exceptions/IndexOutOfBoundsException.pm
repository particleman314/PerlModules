package HP::Array::Exceptions::IndexOutOfBoundsException;
...
BEGIN 
  {
    ...
    $module_require_list = {							
							...
							'HP::Array::Exceptions::BaseArrayException' => undef,
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_array_exceptions_indexoutofbounds_pm'} ||
	             $ENV{'debug_array__modules'} ||
...
sub new
  {
    return &HP::Array::Exceptions::BaseArrayException::new($_[0], __PACKAGE__, &data_types(), @_[ 1..scalar(@_)-1 ]);
  }
