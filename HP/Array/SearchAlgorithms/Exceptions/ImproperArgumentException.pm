package HP::Array::SearchAlgorithms::Exceptions::ImproperArgumentException;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_array_searchalgorithms_exceptions_improperargumentexception_pm'} ||
	             $ENV{'debug_array_searchalgorithms_exceptions_modules'} ||
 	             $ENV{'debug_array_searchalgorithms_modules'} ||
...
sub new
  {
    ...
    bless $self, $class;
	$self->instantiate();
	$self->type(&module_routine(__PACKAGE__));
