...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
                 $ENV{'debug_providers_groups_pm'} ||
                 $ENV{'debug_providers_modules'} ||
				 $ENV{'debug_cloudcapsule_modules'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
	                   'group_id' => undef,
	                   'group'    => '[] c__HP::Providers::GroupSupport__ 1',
		              };
...
#=============================================================================
sub increment_internal_count
  {
    my $self = shift;
	++$internal_count;
	
	my $label= "group_$internal_count";
	$self->group_id($label);
	return TRUE;
  }
