package HP::CapsuleMetadata::OO::OOEngine;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_capsulemetadata_oo_ooengine'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
	                   folders => '[] c__HP::CapsuleMetadata::OO::OOEngineFolder__',
		              };
...
sub write_as_attributes
  {
    my $self = shift;
    my $specific = &get_fields($self, FALSE);

    $specific = &set_difference($specific, [ 'folders' ]);
    return $specific;
  }
