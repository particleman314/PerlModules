package HP::CapsuleMetadata::OO::InstallerData;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_capsulemetadata_oo_installerdata'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
					   ...
					   'ooengines'       => 'c__HP::CapsuleMetadata::OO::OOEngines__',
					   'ootag'           => OO_VERSION_10,
					   'dependencies'    => 'c__HP::CapsuleMetadata::OO::FlowDependency__',
		              };
