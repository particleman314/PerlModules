package HP::CapsuleMetadata::UseCase::InstallerData;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_capsulemetadata_usecase_installerdata'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
					   ...
					   'serviceblueprints'  => 'c__HP::CapsuleMetadata::UseCase::ServiceDesigns__',
					   'scripts'            => '[] c__HP::CapsuleMetadata::UseCase::Script__ 1',
		              };
