package HP::CapsuleMetadata::UseCase::ServiceDesign;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_capsulemetadata_usecase_servicedesign_pm'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
					   ...
					   'dependencies'    => '[] c__HP::CapsuleMetadata::UseCase::Dependency__',
		              };
...
sub pre_callback_write
  {
    my $self  = shift;
	$self->version()->as_node();
	$self->version()->update_skip_fields(['comparison']);
	return TRUE;
  }
