package HP::CapsuleMetadata::UseCase::ServiceDesigns;
...
BEGIN 
  {
    ...
    $is_init  = 0;
    $is_debug = (
	             $ENV{'debug_capsule_metadata_usecase_servicedesigns'} ||
                 $ENV{'debug_capsule_metadata_usecase_modules'} ||
				 $ENV{'debug_capsule_metadata_modules'} ||
...
sub data_types
  {
    ...
    my $data_fields = {
	                   'blueprint' => '[] c__HP::CapsuleMetadata::UseCase::ServiceDesign__',
		              };
