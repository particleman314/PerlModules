package HP::Support::Screen::Constants;
...
BEGIN
  {
    ...
    $is_init  = 0;
    $is_debug = (
	         $ENV{'debug_support_screen_constants_pm'} ||
	         $ENV{'debug_support_screen_modules'} ||
...
#=============================================================================
use constant TERM_CAP_OSPEED => 9600;

use constant DEFAULT_ROWS    => 24;
use constant DEFAULT_COLS    => 80;
